...
module edb_top (
    ...
    output bscan_TDO,
    input  la0_clk,
    input  [3:0] la0_probe0,
    input  [15:0] la0_probe1,
    input  [7:0] la0_probe2,
    input  la0_probe3,
    input  [15:0] la0_probe4,
    input  [3:0] la0_probe5,
    input  [15:0] la0_probe6,
    input  [15:0] la0_probe7,
    input  [15:0] la0_probe8,
    input  la0_probe9,
    input  [10:0] la0_probe10,
    input  la0_probe11,
    input  [15:0] la0_probe12,
    input  [31:0] la0_probe13,
    input  [15:0] la0_probe14,
    input  la0_probe15,
    input  [23:0] la0_probe16,
    input  [15:0] la0_probe17,
    input  la0_probe18,
    input  [15:0] la0_probe19,
    input  [4:0] la0_probe20,
    input  [3:0] la0_probe21,
    input  la0_probe22,
    input  [15:0] la0_probe23,
    input  [10:0] la0_probe24,
    input  [15:0] la0_probe25,
    input  [23:0] la0_probe26,
    input  [15:0] la0_probe27,
    input  [15:0] la0_probe28,
    input  la0_probe29,
    input  la0_probe30
);
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 1 ),
        .UUID   ( 128'h9da89e11637c4080b15f75559e91a89d ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 4 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 16 ),
