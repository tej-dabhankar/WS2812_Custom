...
module edb_top (
    ...
    output bscan_TDO,
    input  la0_clk,
    input  [23:0] la0_probe0,
    input  la0_probe1,
    input  [15:0] la0_probe2,
    input  [7:0] la0_probe3,
    input  [7:0] la0_probe4,
    input  [15:0] la0_probe5,
    input  la0_probe6,
    input  la0_probe7,
    input  [23:0] la0_probe8,
    input  la0_probe9,
    input  [15:0] la0_probe10,
    input  [15:0] la0_probe11,
    input  la0_probe12,
    input  la0_probe13,
    input  la0_probe14,
    input  la0_probe15,
    ...
    input  la0_probe19,
    input  la0_probe20,
    input  [7:0] la0_probe21,
    input  la0_probe22,
    input  [7:0] la0_probe23,
    input  la0_probe24
);
    ...
    edb_la_top #(
        ...
        .INPUT_PIPE_STAGES      ( 1 ),
        .CAPTURE_CONTROL    ( 1 ),
        .UUID   ( 128'h4320cdf61d704edbb8c73e43fb7cae9c ),
        .CNDTNL_STRG_EN     ( 0 ),
        .PROBE0_WIDTH       ( 24 ),
        .PROBE0_TYPE        ( 1 ),
        .PROBE1_WIDTH       ( 1 ),
